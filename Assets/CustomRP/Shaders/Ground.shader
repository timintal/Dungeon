Shader "Custom/Ground"
{
    ...
    Properties
    {
        ...
        _VariationTex("Variation Texture", 2D) = "white"{}
    ...
    SubShader
    {
        Pass
        {
            ...
            UNITY_INSTANCING_BUFFER_START(UnityPerMaterial)
	            ...
	            UNITY_DEFINE_INSTANCED_PROP(float4, _VariationTex_ST)
            ...
            Varyings vert (Attributes IN)
            {
            	...
            	float4 variationST = UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _VariationTex_ST);
				OUT.uv2 = IN.uv * variationST.xy + variationST.zw;
            ...
            half4 frag (Varyings IN) : SV_TARGET
            {
            	...
            	half4 variationMap = SAMPLE_TEXTURE2D(_VariationTex, sampler_VariationTex, IN.uv2);
                half4 base = UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _BaseColor);
                half4 second = UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial, _SecondColor);
            	base = lerp(base, second, smoothstep(0.47, 0.53, variationMap.r));
